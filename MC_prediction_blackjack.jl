...
@time V = mc_prediction(500000, 17)
...
p1 = scatter3d(player_sums_usable, dealer_cards_usable, est_values_usable, zcolor=est_values_usable, xlabel="Player sum", ylabel="Dealer card", zlabel="State-value estimate", title="Usable ace: State-value estimates", colorbar=true, legend=false, view=(60, 45))
p2 = scatter3d(player_sums_non_usable, dealer_cards_non_usable, est_values_non_usable, zcolor=est_values_non_usable, xlabel="Player sum", ylabel="Dealer card", zlabel="State-value estimate", title="No usable ace: State-value estimates", colorbar=true, legend=false, view=(60, 45))
